        ...
        Group {
            if isLoading {
                ...
                FormView {
                        ...
                        Do not enforce memory limits on the VPN Direct core. Will cause OOM on non-jailbroken devices.
                    ...
                    #if !os(tvOS)
                        // includeAllNetworks (Kill Switch) permanently removed — it can black-hole Wi‑Fi.
