...
struct DirectPlansView: View {
    ...
    private let plans: [DirectPresetPlan] = [
        .init(id: "start", name: "START", trafficGB: 100, whiteListGB: 20, devices: 1, badge: nil, subtitle: "Для одного устройства"),
        .init(id: "plus", name: "PLUS", trafficGB: 300, whiteListGB: 50, devices: 3, badge: "ПОПУЛЯРНЫЙ", subtitle: "Оптимальный вариант"),
        .init(id: "pro", name: "PRO", trafficGB: 700, whiteListGB: 100, devices: 5, badge: nil, subtitle: "Для нескольких устройств"),
        .init(id: "max", name: "MAX", trafficGB: 2000, whiteListGB: 250, devices: 10, badge: nil, subtitle: "Большой запас трафика"),
        .init(id: "ultra", name: "ULTRA", trafficGB: nil, whiteListGB: 500, devices: 20, badge: "UNLIMITED", subtitle: "Без ограничений по трафику"),
    ]
    ...
    private func planCard(_ plan: DirectPresetPlan) -> some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack(spacing: 0) {
                ...
                fact("WHITE-LIST", "\(plan.whiteListGB) GB")
        ...
        .overlay(
            Rectangle().stroke(
                plan.id == "plus" ? DS.ink : DS.line,
                lineWidth: plan.id == "plus" ? 1.5 : 1
            )
        )
    }
