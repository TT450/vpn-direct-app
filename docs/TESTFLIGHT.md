...
| Build | **108** (balance / top-up UI polish) |
| Bundle ID | `com.vpndirect.vpndirectapp` |
| GitHub tag | [`v1.0.11.108`](https://github.com/TT450/vpn-direct-app/releases/tag/v1.0.11.108) |

Prefer **108+**. Older builds may still appear in history.
...
4. Assign the latest build (1.0.11 / **108+**).
