...
| Build | **109** (privacy disclosure + renew fixes) |
| Bundle ID | `com.vpndirect.vpndirectapp` |
| GitHub tag | [`v1.0.11.109`](https://github.com/TT450/vpn-direct-app/releases/tag/v1.0.11.109) |

Prefer **109+**. Older builds may still appear in history.
...
4. Assign the latest build (1.0.11 / **109+**).
