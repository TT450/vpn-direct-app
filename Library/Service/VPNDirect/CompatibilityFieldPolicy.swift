...
public enum CompatibilityFieldPolicy {
    ...
    public static let protocolSpecificKeys: [String: Set<String>] = [
        ...
        "vmess": [
            ...
            // Vendor / panel metadata seen in free pools — never connection-critical alone.
            "vcn", "pcs", "test_name", "testname",
        ],
        "trojan": [
            "password", "network", "sni", "alpn", "fp", "path", "host", "servicename", "multiplex",
            "wspath", "ws", "cs", "cipher_suites", "fm", "allowinsecure", "allow_insecure", "insecure",
        ],
        "shadowsocks": ["method", "cipher", "password", "plugin", "plugin_opts", "plugin-opts", "udp_over_tcp", "multiplex", "network"],
        "shadowsocksr": [
            "method", "cipher", "password", "protocol", "obfs", "protocol_param", "protoparam",
            "obfs_param", "obfsparam", "protocol-param", "obfs-param", "group", "remarks",
        ],
        "hysteria2": [
            "password", "auth", "up", "down", "up_mbps", "down_mbps", "obfs", "obfs_password",
            "obfs-password", "server_ports", "mport", "hop_interval", "hop_interval_max", "sni", "alpn",
            "insecure", "allowinsecure", "min_packet_size", "max_packet_size",
            "obfs_min_packet_size", "obfs_max_packet_size", "fm", "security", "type", "note", "telegram",
        ],
        ...
        "anytls": [
            "password", "idle_session_check_interval", "idle_session_timeout", "min_idle_session",
            "sni", "disable_sni", "username", "security", "type", "udp", "packetencoding", "packet_encoding",
        ...
        "wireguard": [
            "private_key", "privatekey", "peer_public_key", "public_key", "publickey", "public-key",
            "local_address", "address", "pre_shared_key", "preshared_key", "presharedkey", "preshared-key",
            "mtu", "allowed_ips", "allowedips", "persistent_keepalive_interval", "persistentkeepalive",
            "keepalive", "reserved", "peer_count",
            // Hiddify / client junk-noise aliases — mapped onto AWG jc/jmin/jmax when present.
            "wnoise", "wnoisecount", "wnoisedelay", "wpayloadsize",
        ],
        "amneziawg": [
            "private_key", "privatekey", "peer_public_key", "public_key", "publickey", "public-key",
            "local_address", "address", "pre_shared_key", "preshared_key", "presharedkey",
            "jc", "jmin", "jmax",
            ...
            "amnezia_version", "peer_count", "mtu", "reserved", "keepalive",
            "wnoise", "wnoisecount", "wnoisedelay", "wpayloadsize",
        ],
    ...
    public static let knownProtocolKeys: Set<String> = [
        ...
        "obfs", "obfs_password", "obfs_param", "obfsparam", "protocol_param", "protoparam",
        "auth", "auth_str", "up", "down", "up_mbps", "down_mbps",
        "upmbps", "downmbps", "mtu",
        ...
        "fm", "obfsparam", "obfs_param", "protocol", "protocol_param", "protoparam", "remarks",
        ...
        "wnoise", "wnoisecount", "wnoisedelay", "wpayloadsize",
        "wspath", "ws", "cs", "cipher_suites", "mport", "vcn", "pcs", "test_name", "testname",
        "note", "telegram", "obfs-password",
    ]
