...
public struct VPNDirectProtocolID: RawRepresentable, Hashable, Sendable, Codable {
    ...
    public static let shadowsocksr = VPNDirectProtocolID(rawValue: "shadowsocksr")
    ...
    public static let openvpn = VPNDirectProtocolID(rawValue: "openvpn")
    public static let openconnect = VPNDirectProtocolID(rawValue: "openconnect")
    public static let tailscale = VPNDirectProtocolID(rawValue: "tailscale")
    public static let masqueConnectUDP = VPNDirectProtocolID(rawValue: "masque-connect-udp")
}
