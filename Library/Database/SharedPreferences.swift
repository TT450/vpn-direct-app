...
public enum SharedPreferences {
    ...
    public static let preferredOutboundTag = Preference<String>("preferred_outbound_tag", defaultValue: "")

    // Direct app settings
    public static let appLockEnabled = Preference<Bool>("app_lock_enabled", defaultValue: false)
    public static let trustedWifiSSIDs = Preference<[String]>("trusted_wifi_ssids", defaultValue: [])
    public static let unknownWifiConnect = Preference<Bool>("unknown_wifi_connect", defaultValue: true)
    public static let connectionMode = Preference<String>("connection_mode", defaultValue: "Авто")
    public static let autoFailover = Preference<Bool>("auto_failover", defaultValue: true)
    /// Russian domains/IPs go direct (outside VPN). Default on.
    public static let bypassRussianSites = Preference<Bool>("bypass_russian_sites", defaultValue: true)
